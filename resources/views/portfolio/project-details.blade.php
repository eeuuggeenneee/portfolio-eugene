...
<!-- Mirrored from ui-themez.smartinnovates.net/items/hawke/project-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Aug 2023 13:52:03 GMT -->
<head>
    ...
    <nav class="navbar navbar-expand-lg static">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="home-main.html"><span class="rolling-text">Home</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="home-main.html"><span class="rolling-text">About</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="home-main.html"><span class="rolling-text">Services</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="home-main.html"><span class="rolling-text">Portfolio</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="home-main.html"><span class="rolling-text">Testimonials</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="home-main.html"><span class="rolling-text">Blog</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="home-main.html"><span class="rolling-text">Contact</span></a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center">
                        <p class="fz-13">© 2023 Hawke is Proudly Powered by <span class="underline main-color"><a
...
<!-- Mirrored from ui-themez.smartinnovates.net/items/hawke/project-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Aug 2023 13:52:06 GMT -->
</html>